...
if __name__ == "__main__":
    ...
    # battle(Board(show_board=True, show_result=True), SmartPlayer(), PerfectPlayer(), 1, learn=False, show_result=True)
    ...
    board = Board()
    battle(board, PerfectPlayer(), RandomPlayer(), NUM, learn=False, show_result=True)
    battle(board, RandomPlayer(), PerfectPlayer(), NUM, learn=False, show_result=True)

    battle(Board(show_board=True, show_result=True), qlearner, PerfectPlayer(), 1, learn=False, show_result=True)
    # print(qlearner.q_values)

    """
    battle(board, RandomPlayer(), RandomPlayer(), 500, show_result=True)
