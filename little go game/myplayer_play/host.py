...
from myplayer_play.read import *
from myplayer_play.write import writeNextInput

# TODO: You are not allowed to copy/paste. It's not fair to those students who are using the other languages.
# You can read and understand it, then implement it again by yourself.
