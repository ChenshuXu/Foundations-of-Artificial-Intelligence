...
def evaluate_move(board_int, piece_type, move, debug=False):
    ...
    return win_s * 0.3 + kill_s * 8 + kill_s2 * 2 + be_killed_s * 10 + liberty_s * 0.2 + connection_score * 1 + edge_s * 0.1
    # return win_s * 0.3 + kill_s * 8 + be_killed_s * 10 + liberty_s * 0.1 + connection_score * 1 + edge_s * 0.1
...
def liberty_score(board_int, piece_type, move):
    ...
    # previous_liberty = count_liberty(board_int, piece_type)
    after_liberty = count_liberty(test_board_int, piece_type)
